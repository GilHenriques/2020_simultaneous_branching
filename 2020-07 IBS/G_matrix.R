...
cowplot::plot_grid(cowplot::plot_grid(p1, p2, labels = c("A", "B"), 
                   rel_widths = c(1.7, 2), nrow = 1,
                   align = "h", axis = "b"),
                   p3, labels = c("", "C"), rel_widths = c(2.5, 1), nrow = 1)


ggsave("2020-07 IBS/direction_G_matrix.pdf", width = 8.5, height = 3.5)
